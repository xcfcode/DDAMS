...
def _feature_tokenize(
    ...
    Example:
        feature_tokenize("u11|A u12|B u13|C u14|D u15|E u16|F",feat_delim="|",layer=X)
...
def text_fields(**kwargs):
    ...
    bos = kwargs.get("bos", "<s>")  # for src none
    eos = kwargs.get("eos", "</s>")  # for src none
    ...
    for i in range(n_feats + 1):
        ...
        # example field names : src_feat_1, src_feat_2
        feat = Field(
