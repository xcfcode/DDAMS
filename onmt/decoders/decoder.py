...
class RNNDecoderBase(DecoderBase):
    ...
    def forward(self, tgt, memory_bank, memory_lengths=None, memory_bank_utterance=None, memory_lengths_utterance=None,
                hier_matrix=None, step=None):
        """
        Args:
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, memory_lengths=None, memory_bank_utterance=None,
                          memory_lengths_utterance=None, hier_matrix=None):
        """
        ...
        for emb_t in emb.split(1):
            ...
            if self.attentional:
                decoder_output, p_attn = self.attn(
                    ...
                    memory_bank.transpose(0, 1),
                    memory_lengths=memory_lengths,
                    memory_bank_utterance=memory_bank_utterance.transpose(0, 1),
                    memory_lengths_utterance=memory_lengths_utterance,
                    hier_matrix=hier_matrix)
