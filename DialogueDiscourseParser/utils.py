...
def preview_data(test_data,data, pred, map_relations, vocab, idx):
    map_relations_inv = {}
    for item in map_relations:
        map_relations_inv[map_relations[item]] = item
    for i, dialog in enumerate(data):
        ...
        for relation in pred[i]:
            wf.write("{} {} {}".format(relation[0], map_relations_inv[relation[2]], relation[1]))
            wf.write("\n")
            print relation[0], map_relations_inv[relation[2]], relation[1]
